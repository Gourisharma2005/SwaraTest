...
public class ComplaintDAO {
    public static boolean insertComplaint(Complaint complaint) {
        ...
        try (Connection conn = DBConnection.getConnection()) {
            String sql = "INSERT INTO complaints (anonymous_id, complaint_name, licensee, location, incident_date, description, recipient, department, status, document, file_name) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
            ...
            stmt.setString(7, complaint.getRecipient());
